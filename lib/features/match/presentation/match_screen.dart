    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _LoadingStep(
              label: 'Starting CS2 server', isDone: false, isActive: true),
...
class _LoadingStep extends StatelessWidget {
  ...
  const _LoadingStep(
      {required this.label, this.isDone = false, this.isActive = false});
        ...
        children: [
          if (isDone)
            ...
            Icon(Icons.circle_outlined,
                color: AppColors.textTertiary.withValues(alpha: 0.3), size: 16),
...
class _ScoreHeader extends StatelessWidget {
  ...
  const _ScoreHeader(
      {required this.match, required this.teamA, required this.teamB});
...
class _PlayerStatRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(children: [
        ...
        _stat(player.hltvRating.toStringAsFixed(2),
            color: _rc(player.hltvRating)),
        _stat(
            player.eloChange != 0
                ? Formatters.eloChange(player.eloChange)
                : '-',
            color: player.eloChange > 0
                ? AppColors.success
                : player.eloChange < 0
                    ? AppColors.danger
                    : AppColors.textTertiary),
  ...
  Widget _stat(String v, {Color? color}) => SizedBox(
      width: 65,
      child: Text(v,
          textAlign: TextAlign.center,
          style: AppTextStyles.mono.copyWith(

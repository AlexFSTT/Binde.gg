...
class _MatchScreenState extends State<MatchScreen> {
  ...
  Future<void> _loadMatch() async {
    ...
    if (result.isSuccess) {
      ...
      Log.d(
          'Match loaded - status: ${_match!.status}, map: ${_match!.map}, connectString: ${_match!.connectString}');
  ...
  void _checkAndProvision() {
    ...
    Log.d(
        '_checkAndProvision: status=${_match!.status}, connect=${_match!.connectString}, provisioning=$_isProvisioning');
  ...
  void _subscribeRealtime() {
    ...
    _realtime.subscribeMatch(
      ...
      onMatchUpdate: (data) {
        ...
        Log.d(
            'Realtime update: $oldStatus → ${updated.status}, connect: ${updated.connectString}');
  ...
  Future<void> _provisionServer() async {
    ...
    try {
      ...
      if (response.status != 200) {
        ...
        Log.d(
            '>>> Provision call succeeded! Waiting for realtime update with connect string...');
      }
    } catch (e, stack) {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        ...
        Text(
            'This takes 15-30 seconds. Server is being provisioned with MatchZy.',
            style: AppTextStyles.bodyMedium
                .copyWith(color: AppColors.textTertiary),
      ...
      child: Column(children: [
        Container(
          ...
          child: Row(children: [
            ...
            Text(label,
                style: AppTextStyles.label
                    .copyWith(color: color, fontSize: 12, letterSpacing: 1.0)),
          ]),
        ),
        Padding(
